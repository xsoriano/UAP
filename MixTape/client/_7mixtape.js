...
// MixTape.setCurrentBookmark = function(currentBookmarkId){
// 	var bookmarkData = bookmarksDB.find({_id:currentBookmarkId}).fetch()[0];

// 	if(bookmarkData){
// 		var bookmarkClip = bookmarkData.clip;	
// 		var selectedPlaylist = Session.get(ACTIVE_PLAYLIST_KEY);
// 		var currentClip = Session.get(CURRENT_CLIP_KEY);
// 		var currentPlaylist = (clipsDB.find({_id:currentClip}).fetch()[0]).playlist;
// 		if(currentPlaylist == selectedPlaylist && bookmarkClip == currentClip){
// 			 if(selected_bookmark_identifier == null || selected_bookmark_identifier != currentBookmark.dbId){
// 				selected_bookmark_identifier = currentBookmark.dbId;
// 				is_bookmark_selected = true;
// 				selectedPlaylist = currentClip.playlist();
...
// MixTape.playWhenMetadataLoaded = function(changeClip){
